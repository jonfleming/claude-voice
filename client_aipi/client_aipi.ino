...
// ============ AIPI-Lite GPIO Configuration ============
// Button: GPIO42 (Right button, digital INPUT_PULLUP)
#define BUTTON_PIN 42

// Audio Output (I2S to ES8311 DAC -> Speaker Amp)
#define AUDIO_OUTPUT_BCLK 14   // Bit Clock
#define AUDIO_OUTPUT_LRC 12    // Frame Clock (LRCLK)
#define AUDIO_OUTPUT_DOUT 11   // Data Out
#define AUDIO_OUTPUT_MCLK 6    // Master Clock

// Audio Input (I2S from ES8311 codec, ES8311 handles mic->codec via analog)
#define AUDIO_INPUT_MCLK 6     // Master Clock (shared)
#define AUDIO_INPUT_WS 12      // Frame Clock (shared with output)
#define AUDIO_INPUT_DIN 13     // Data In from ES8311 codec

// Power Management & Battery (AIPI-Lite specific)
#define POWER_KEEP_ALIVE_PIN 10  // CRITICAL: Must be HIGH on boot
#define BATTERY_ADC_PIN 2        // Battery voltage monitoring (optional)
...
void play_backend_audio_base64(const String &b64_audio) {
  ...
  // Enable speaker amplifier for AIPI-Lite
  ...
  // Disable speaker amplifier after playback
...
void setup() {
  ...
  audio_input_init(AUDIO_INPUT_MCLK, AUDIO_INPUT_WS, AUDIO_INPUT_DIN);
